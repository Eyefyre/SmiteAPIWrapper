...
public class SmiteClient implements SmiteClientInterface {
    ...
    @Override
    public NamedAPIResourceList getGodList() {
        return (NamedAPIResourceList) this.getObject("gods", "NamedAPIResourceList");
    }

    @Override
    public NamedAPIResourceList getAbilityList() {
        return (NamedAPIResourceList) this.getObject("abilities", "NamedAPIResourceList");
    }
    ...
    public Achievement getAchievement(String name) {
        return (Achievement) this.getObject("achievements", name.replace("?", "%3F"), "Achievement");
    }
    ...
    public Ability getAbility(int id) {
        return (Ability) this.getObject("abilities", id, "Ability");
    }

    @Override
    public Ability getAbility(String name) {
        return (Ability) this.getObject("abilities", name, "Ability");
    }

    @Override
    public God getGod(int id) {
        return (God) this.getObject("gods", id, "God");
    }

    @Override
    public God getGod(String name) {
        return (God) this.getObject("gods", name, "God");
    }
}
